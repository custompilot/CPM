...
namespace CustomPilot.control
{
    public partial class UC_TabFirmware : UserControl
    {
        ...
        public bool IsConnected
        {
            set
            {
                ...
                else
                {
                    ...
                    __pid_label.Text = __version_label.Text = __version_label.Text = Languages.PAGE_FIRM_DISCONNECTED;
        ...
        {
            _information_groupBox.Text = Languages.PAGE_FIRM_INFORMATION;
            _id_label.Text = Languages.PAGE_FIRM_PRODUCTID;
            _firmware_label.Text = Languages.PAGE_FIRM_FIRMWARE;
            _name_label.Text = Languages.PAGE_FIRM_NAME;

            _firmwareBackup_groupBox.Text = Languages.PAGE_FIRM_FIRMWAREBACKUP;
            _file_label1.Text = Languages.PAGE_FIRM_FILE;
            _firmware_down_open_file_button.Text = Languages.PAGE_FIRM_SAVE;
            _ver_label1.Text = Languages.PAGE_FIRM_VER;
            _state_label1.Text = Languages.PAGE_FIRM_STATE;
            _firmware_dowload_button.Text = Languages.PAGE_FIRM_DOWNLOAD;

            _firmwareUpload_groupBox.Text = Languages.PAGE_FIRM_FIRMWAREUPLOAD;
            _file_label2.Text = Languages.PAGE_FIRM_FILE;
            _firmware_up_open_file_button.Text = Languages.PAGE_FIRM_OPEN;
            _ver_label2.Text = Languages.PAGE_FIRM_VER;
            _state_label2.Text = Languages.PAGE_FIRM_STATE;
            _firmware_upload_button.Text = Languages.PAGE_FIRM_UPLOAD;

            _console_groupBox.Text = Languages.PAGE_FIRM_CONSOLE;
        }
