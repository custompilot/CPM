...
namespace CustomPilot.control
{
    ...
    public partial class UC_TabRadio : UserControl
    {
        ...
        {
            _protocol_groupBox.Text = Languages.PAGE_RADIO_PROTOCOL;
            _hz_label.Text = Languages.PAGE_RADIO_RADIOHZ;
            _input_label.Text = Languages.PAGE_RADIO_INPUTCHANNELS;
            _calibration_groupBox.Text = Languages.PAGE_RADIO_CALIBRATION;
            _min_label.Text = Languages.PAGE_RADIO_MIN;
            _center_label.Text = Languages.PAGE_RADIO_CENTER;
            _max_label.Text = Languages.PAGE_RADIO_MAX;

            _default_button.Text = _ich_default_button.Text = Languages.PAGE_RADIO_DEFAULT;
            _save_radio_button.Text = Languages.PAGE_RADIO_SAVE;
        }
        ...
        public UC_TabRadio()
        {
            ...
            __protocol_comboBox.DataSource = Enum.GetValues(typeof(___RADIO_PROTOCOL));
        ...
        public void Decode_EEPROM()
        {
            ...
            __protocol_comboBox.SelectedIndex = Communication.EEPROM.radio.protocol;
        ...
        public void Decode_radio(byte[] radio)
        {
            for (int i = 0; i < 16; i++)
            {
                _ch_monitors[i].Current = BitConverter.ToInt16(radio, 32 + i * 2);
                _ch_labels[i].Text = BitConverter.ToInt16(radio, 32 + i * 2).ToString();
            }
        }
        ...
        private void __ch16_comboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            // 현재 채널 번호 역할을 NA로
            byte[] roles = new byte[(int)S_EEPROM.ICH.MODEC];
