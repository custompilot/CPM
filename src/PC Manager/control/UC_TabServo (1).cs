...
namespace CustomPilot.control
{
    public partial class UC_TabServo : UserControl
    {
        ...
        {
            _channel_groupBox.Text = Languages.PAGE_OUTPUT_CHANNEL;
            _ich_default_button.Text = Languages.PAGE_OUTPUT_DEFAULT;
            _output_groupBox.Text = Languages.PAGE_OTUPUT_OUTPUT;
            _pulse_label.Text = Languages.PAGE_OUTPUT_PULSE;
            _min_label.Text = Languages.PAGE_OUTPUT_MIN;
            _max_label.Text = Languages.PAGE_OUTPUT_MAX;
            _center_label.Text = Languages.PAGE_OUTPUT_CENTER;
            _default_trim_button.Text = Languages.PAGE_OUTPUT_DEFAULT;
