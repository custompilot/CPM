...
namespace CustomPilot.control
{
    public partial class UC_Mount : UserControl
    {
        ...
        private void load_currentimage()
        {
            ...
            {
                __picture.Image = Bitmap.FromFile("./images/image1.jpg");
            }else if (__backword_comboBox.SelectedIndex == 1 && __reverse_comboBox.SelectedIndex == 0)
            {
                __picture.Image = Bitmap.FromFile("./images/image2.jpg");
            }else if (__backword_comboBox.SelectedIndex == 0 && __reverse_comboBox.SelectedIndex == 1)
            {
                __picture.Image = Bitmap.FromFile("./images/image3.jpg");
            }else if (__backword_comboBox.SelectedIndex == 1 && __reverse_comboBox.SelectedIndex == 1)
            {
                __picture.Image = Bitmap.FromFile("./images/image4.jpg");
            }
        }

        public void set_language()
        {
            __install_groupBox.Text = Languages.PAGE_MOUNT_NAME;
            __fb_groupBox.Text = Languages.PAGE_MOUNT_FRONTBACK;
            __tb_groupBox.Text = Languages.PAGE_MOUNT_TOPBOTTOM;
            __backword_comboBox.Items.Clear();
            __backword_comboBox.Items.Add(Languages.PAGE_MOUNT_FRONT);
            __backword_comboBox.Items.Add(Languages.PAGE_MOUNT_BACK);
            __reverse_comboBox.Items.Clear();
            __reverse_comboBox.Items.Add(Languages.PAGE_MOUNT_TOP);
            __reverse_comboBox.Items.Add(Languages.PAGE_MOUNT_BOTTOM);
